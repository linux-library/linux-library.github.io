...
const DISTROS = [
  {
    ...
    links: [
      ...
      { url: 'https://releases.ubuntu.com/resolute/ubuntu-26.04-live-server-amd64.iso',                                           architecture: 'x64 (recommended)', type: 'Server' },
      { url: 'https://cdimages.ubuntu.com/ubuntu/releases/resolute/release/ubuntu-26.04-desktop-arm64.iso',                       architecture: 'ARM64',             type: 'Desktop' },
      { url: 'https://cdimages.ubuntu.com/ubuntu/releases/resolute/release/ubuntu-26.04-live-server-arm64.iso',                   architecture: 'ARM64',             type: 'Server' },
      { url: 'https://cdimages.ubuntu.com/ubuntu/releases/resolute/release/ubuntu-26.04-preinstalled-desktop-arm64+raspi.img.xz', architecture: 'Raspberry Pi',      type: 'Desktop' },
      { url: 'https://cdimages.ubuntu.com/ubuntu/releases/resolute/release/ubuntu-26.04-preinstalled-server-arm64+raspi.img.xz',  architecture: 'Raspberry Pi',      type: 'Server' },
    ],
  },
  {
    name: 'Linux Mint',
    ...
    links: [
      ...
      { url: 'https://pub.linuxmint.io/stable/22.3/linuxmint-22.3-xfce-64bit.iso',     architecture: 'x64', desktop: 'Xfce' },
      { url: 'https://pub.linuxmint.io/stable/22.3/linuxmint-22.3-mate-64bit.iso',     architecture: 'x64', desktop: 'MATE' },
    ],
  },
  {
    name: 'Debian',
    ...
    links: [
      ...
      { url: 'https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.4.0-amd64-kde.iso',      architecture: 'x64 (recommended)', desktop: 'KDE Plasma' },
      { url: 'https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.4.0-amd64-cinnamon.iso', architecture: 'x64 (recommended)', desktop: 'Cinnamon' },
      { url: 'https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.4.0-amd64-lxde.iso',     architecture: 'x64 (recommended)', desktop: 'LXDE' },
      { url: 'https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.4.0-amd64-lxqt.iso',     architecture: 'x64 (recommended)', desktop: 'LXQt' },
      { url: 'https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.4.0-amd64-mate.iso',     architecture: 'x64 (recommended)', desktop: 'MATE' },
      { url: 'https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.4.0-amd64-xfce.iso',     architecture: 'x64 (recommended)', desktop: 'Xfce' },
      { url: 'https://cdimage.debian.org/debian-cd/current/amd64/iso-dvd/debian-13.4.0-amd64-DVD-1.iso',                 architecture: 'x64 (recommended)', desktop: 'None' },
      { url: 'https://cdimage.debian.org/debian-cd/current/arm64/iso-dvd/debian-13.4.0-arm64-DVD-1.iso',                 architecture: 'ARM64',             desktop: 'None' },
      { url: 'https://cloud.debian.org/images/cloud/trixie/daily/latest/debian-13-raspi-arm64-daily.tar.xz',             architecture: 'Raspberry Pi',      desktop: 'None' },
    ],
  },
  {
    name: 'Fedora',
    ...
    links: [
      ...
      { url: 'https://download.fedoraproject.org/pub/fedora/linux/releases/44/Workstation/aarch64/iso/Fedora-Workstation-Live-44-1.7.aarch64.iso',       architecture: 'ARM64',             desktop: 'GNOME (recommended)' },
      { url: 'https://download.fedoraproject.org/pub/fedora/linux/releases/44/Workstation/aarch64/images/Fedora-Workstation-Disk-44-1.7.aarch64.raw.xz', architecture: 'Raspberry Pi',      desktop: 'GNOME (recommended)' },
      { url: 'https://download.fedoraproject.org/pub/fedora/linux/releases/44/KDE/x86_64/iso/Fedora-KDE-Desktop-Live-44-1.7.x86_64.iso',                 architecture: 'x64 (recommended)', desktop: 'KDE Plasma' },
      { url: 'https://download.fedoraproject.org/pub/fedora/linux/releases/44/KDE/aarch64/iso/Fedora-KDE-Desktop-Live-44-1.7.aarch64.iso',               architecture: 'ARM64',             desktop: 'KDE Plasma' },
      { url: 'https://download.fedoraproject.org/pub/fedora/linux/releases/44/KDE/aarch64/images/Fedora-KDE-Desktop-Disk-44-1.7.aarch64.raw.xz',         architecture: 'Raspberry Pi',      desktop: 'KDE Plasma' },
    ],
  },
  {
    name: 'Pop!_OS',
    ...
    links: [
      ...
      { url: 'https://iso.pop-os.org/24.04/arm64/generic/3/pop-os_24.04_arm64_generic_3.iso',   architecture: 'ARM64' },
    ],
  },
  {
    name: 'Manjaro',
    ...
    links: [
      ...
      { url: 'https://download.manjaro.org/xfce/26.0.4/manjaro-xfce-26.0.4-260327-linux618.iso',                            architecture: 'x64 (recommended)', desktop: 'Xfce' },
      { url: 'https://download.manjaro.org/gnome/26.0.4/manjaro-gnome-26.0.4-260327-linux618.iso',                          architecture: 'x64 (recommended)', desktop: 'GNOME' },
      { url: 'https://github.com/manjaro-arm/rpi4-images/releases/download/23.02/Manjaro-ARM-kde-plasma-rpi4-23.02.img.xz', architecture: 'Raspberry Pi', desktop: 'KDE Plasma (recommended)' },
      { url: 'https://github.com/manjaro-arm/rpi4-images/releases/download/23.02/Manjaro-ARM-xfce-rpi4-23.02.img.xz',       architecture: 'Raspberry Pi', desktop: 'Xfce' },
      { url: 'https://github.com/manjaro-arm/rpi4-images/releases/download/23.02/Manjaro-ARM-gnome-rpi4-23.02.img.xz',      architecture: 'Raspberry Pi', desktop: 'GNOME' },
    ],
  },
  {
    name: 'Zorin OS',
    ...
    links: [
      ...
      { url: 'https://mirrors.edge.kernel.org/zorinos-isos/18/Zorin-OS-18.1-Education-64-bit.iso', architecture: 'x64', type: 'Education' },
      { url: 'https://mirrors.edge.kernel.org/zorinos-isos/18/Zorin-OS-18.1-Lite-64-bit.iso',      architecture: 'x64', type: 'Lite' },
    ],
  },
  {
    name: 'Arch Linux',
  ...
  },
  {
    ...
    links: [
      ...
      { url: 'https://downloads.raspberrypi.com/raspios_full_arm64/images/raspios_full_arm64-2026-04-21/2026-04-21-raspios-trixie-arm64-full.img.xz', architecture: 'Raspberry Pi 64-bit (recommended)', type: 'Full' },
      { url: 'https://downloads.raspberrypi.com/raspios_lite_arm64/images/raspios_lite_arm64-2026-04-21/2026-04-21-raspios-trixie-arm64-lite.img.xz', architecture: 'Raspberry Pi 64-bit (recommended)', type: 'Lite' },
      { url: 'https://downloads.raspberrypi.com/raspios_armhf/images/raspios_armhf-2026-04-21/2026-04-21-raspios-trixie-armhf.img.xz',                architecture: 'Raspberry Pi 32-bit',               type: 'Standard (recommended)' },
      { url: 'https://downloads.raspberrypi.com/raspios_full_armhf/images/raspios_full_armhf-2026-04-21/2026-04-21-raspios-trixie-armhf-full.img.xz', architecture: 'Raspberry Pi 32-bit',               type: 'Full' },
      { url: 'https://downloads.raspberrypi.com/raspios_lite_armhf/images/raspios_lite_armhf-2026-04-21/2026-04-21-raspios-trixie-armhf-lite.img.xz', architecture: 'Raspberry Pi 32-bit',               type: 'Lite' },
    ],
  },
  {
    name: 'Kubuntu',
  ...
  },
  {
    ...
    links: [
      ...
      { url: 'https://mirrors.jlu.edu.cn/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',           architecture: 'x64 (recommended)', mirror: 'China - Jilin University' },
      { url: 'https://mirror.sjtu.edu.cn/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',           architecture: 'x64 (recommended)', mirror: 'China - SJTU' },
      { url: 'https://mirrors.tuna.tsinghua.edu.cn/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso', architecture: 'x64 (recommended)', mirror: 'China - Tuna' },
      { url: 'https://mirrors.c0urier.net/linux/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',    architecture: 'x64 (recommended)', mirror: 'Denmark - C0urier' },
      { url: 'https://mirror.rznet.fr/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',              architecture: 'x64 (recommended)', mirror: 'France - Rznet' },
      { url: 'https://mirror.alpix.eu/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',              architecture: 'x64 (recommended)', mirror: 'Germany - Alpix' },
      { url: 'https://mirror.diyarciftci.xyz/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',       architecture: 'x64 (recommended)', mirror: 'Germany - Diyarciftci' },
      { url: 'https://mirror.moson.org/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',             architecture: 'x64 (recommended)', mirror: 'Germany - Moson' },
      { url: 'https://ftp.rz.tu-bs.de/pub/mirror/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',   architecture: 'x64 (recommended)', mirror: 'Germany - RZ TU-BS' },
      { url: 'https://fosszone.csd.auth.gr/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',         architecture: 'x64 (recommended)', mirror: 'Greece - Fosszone' },
      { url: 'https://mirror.albony.in/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',             architecture: 'x64 (recommended)', mirror: 'India - Albony' },
      { url: 'https://mirrors.nxtgen.com/endeavouros-mirror/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',    architecture: 'x64 (recommended)', mirror: 'India - Nxtgen' },
      { url: 'https://www.miraa.jp/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',                 architecture: 'x64 (recommended)', mirror: 'Japan - Miraa' },
      { url: 'https://mirror.freedif.org/EndeavourOS/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',           architecture: 'x64 (recommended)', mirror: 'Singapore - Freedif' },
      { url: 'https://mirror.jingk.ai/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',              architecture: 'x64 (recommended)', mirror: 'Singapore - Jingk' },
      { url: 'https://mirrors.urbanwave.co.za/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',      architecture: 'x64 (recommended)', mirror: 'South Africa - Urban Wave' },
      { url: 'https://mirror.funami.tech/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',           architecture: 'x64 (recommended)', mirror: 'South Korea - YuruMirror' },
      { url: 'https://mirror.retropc.se/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.22.iso',            architecture: 'x64 (recommended)', mirror: 'Sweden - Retropc' },
      { url: 'https://mirror.accum.se/mirror/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',       architecture: 'x64 (recommended)', mirror: 'Sweden - Umeå University' },
      { url: 'https://pkg.adfinis-on-exoscale.ch/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',   architecture: 'x64 (recommended)', mirror: 'Switzerland - Adfinis' },
      { url: 'https://mirror.gofoss.xyz/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',            architecture: 'x64 (recommended)', mirror: 'Switzerland - Go Foss' },
      //{ url: '', architecture: 'x64 (recommended)', mirror: 'Taiwan - Archlinux Taiwan' },
      { url: 'https://distrohub.kyiv.ua/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',            architecture: 'x64 (recommended)', mirror: 'Ukraine - Distrohub' },
      { url: 'https://repo.c48.uk/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',                  architecture: 'x64 (recommended)', mirror: 'United Kingdom - C48' },
      { url: 'https://mirrors.gigenet.com/endeavouros/iso/EndeavourOS_Titan-Neo-2026.04.27.iso',          architecture: 'x64 (recommended)', mirror: 'USA - Gigenet' },
      //{ url: '', architecture: 'x64 (recommended)', mirror: 'Vietnam - The MeowSMP' },
      { url: 'https://github.com/endeavouros-arm/images/releases/download/rpi-5b-image/enosLinuxARM-rpi5-latest.img.xz', architecture: 'Raspberry Pi',      model: 'Raspberry Pi 5' },
      { url: 'https://github.com/endeavouros-arm/images/releases/download/rpi-4b-image/enosLinuxARM-rpi4-latest.img.xz', architecture: 'Raspberry Pi',      model: 'Raspberry Pi 4' },
    ],
  },
  {
    name: 'Garuda Linux',
    ...
    links: [
      ...
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/dr460nized/latest.iso',        architecture: 'x64', desktop: 'Dr460nized' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/dr460nized-gaming/latest.iso', architecture: 'x64', desktop: 'Dr460nized Gaming' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/gnome/latest.iso',             architecture: 'x64', desktop: 'GNOME' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/cinnamon/latest.iso',          architecture: 'x64', desktop: 'Cinnamon' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/xfce/latest.iso',              architecture: 'x64', desktop: 'Xfce' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/sway/latest.iso',              architecture: 'x64', desktop: 'Sway' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/i3/latest.iso',                architecture: 'x64', desktop: 'i3' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/hyprland/latest.iso',          architecture: 'x64', desktop: 'Hyprland' },
      { url: 'https://iso.builds.garudalinux.org/iso/latest/garuda/kde-lite/latest.iso',          architecture: 'x64', desktop: 'KDE Lite' },
    ],
  },
  {
    name: 'elementary OS',
    ...
    links: [
      ...
      { url: 'https://ams3.dl.elementary.io/download/MTc3NzkyNTc2Mw==/elementaryos-8.1-stable-arm64.20260219.iso', architecture: 'ARM64', },
    ],
  },
  {
    name: 'KDE neon',
    ...
    links: [
      ...
      { url: 'https://files.kde.org/neon/images/testing/20260428-0435/neon-testing-20260428-0435.iso',              architecture: 'x64', type: 'Testing Edition' },
      { url: 'https://files.kde.org/neon/images/unstable/20260503-1152/neon-unstable-20260503-1152.iso',            architecture: 'x64', type: 'Unstable Edition' },
      { url: 'https://files.kde.org/neon/images/developer/20250901-0038/neon-unstable-developer-20250901-0038.iso', architecture: 'x64', type: 'Developer Edition' },
    ],
  },
  {
    name: 'MX Linux',
    ...
    links: [
      ...
      { url: 'https://sourceforge.net/projects/mx-linux/files/Final/Xfce/MX-25.1_Xfce_ahs_x64.iso/download',    architecture: 'x64 (recommended)', desktop: 'Xfce', type: 'Advanced Hardware Support' },
      { url: 'https://sourceforge.net/projects/mx-linux/files/Final/KDE/MX-25.1_KDE_x64.iso/download',          architecture: 'x64 (recommended)', desktop: 'KDE Plasma' },
      { url: 'https://sourceforge.net/projects/mx-linux/files/Final/Fluxbox/MX-25.1_fluxbox_x64.iso/download',  architecture: 'x64 (recommended)', desktop: 'Fluxbox' },
      { url: 'https://sourceforge.net/projects/mx-linux/files/Final/Xfce/mx23.6_rpi_respin_arm64.zip/download', architecture: 'Raspberry Pi' },
    ],
  },
  {
    name: 'openSUSE',
    ...
    links: [
      ...
      { url: 'https://download.opensuse.org/distribution/leap/16.0/offline/Leap-16.0-offline-installer-aarch64.install.iso',      architecture: 'ARM64',             type: 'Leap (recommended)' },
      { url: 'https://download.opensuse.org/tumbleweed/iso/openSUSE-Tumbleweed-DVD-x86_64-Current.iso',                           architecture: 'x64 (recommended)', type: 'Tumbleweed' },
      { url: 'https://download.opensuse.org/ports/aarch64/tumbleweed/iso/openSUSE-Tumbleweed-DVD-aarch64-Current.iso',            architecture: 'ARM64',             type: 'Tumbleweed' },
    ],
  },
  {
    name: 'deepin',
    ...
    links: [
      ...
      { url: 'https://cdimage.deepin.com/releases/25.1.0/arm64/deepin-desktop-community-25.1.0-arm64.iso', architecture: 'ARM64' },
    ],
  },
  {
    ...
    links: [
      ...
      { url: 'https://developers.redhat.com/content-gateway/file/rhel/Red_Hat_Enterprise_Linux_10.1/rhel-10.1-aarch64-dvd.iso', architecture: 'ARM64' },
    ],
  },
  {
    name: 'Rocky Linux',
    ...
    links: [
      ...
      { url: 'https://download.rockylinux.org/pub/rocky/10/isos/aarch64/Rocky-10-latest-aarch64-dvd.iso',                  architecture: 'ARM64' },
      { url: 'https://download.rockylinux.org/pub/rocky/10/images/aarch64/Rocky-10-SBC-RaspberryPi.latest.aarch64.raw.xz', architecture: 'Raspberry Pi' },
    ],
  },
  {
    name: 'AlmaLinux',
    ...
    links: [
      ...
      { url: 'https://repo.almalinux.org/almalinux/10/isos/aarch64/AlmaLinux-10-latest-aarch64-dvd.iso',                  architecture: 'ARM64' },
      { url: 'https://repo.almalinux.org/almalinux/10/raspberrypi/images/AlmaLinux-10-RaspberryPi-latest.aarch64.raw.xz', architecture: 'Raspberry Pi' },
    ],
  },
  {
    name: 'Oracle Linux',
    ...
    links: [
      ...
      { url: 'https://yum.oracle.com/ISOS/OracleLinux/OL10/u1/aarch64/OracleLinux-R10-U1-aarch64-dvd.iso', architecture: 'ARM64' },
    ],
  },
  {
    name: 'CentOS Stream',
    ...
    links: [
      ...
      { url: 'https://centos-stream.mirrorservice.org/10-stream/BaseOS/aarch64/iso/CentOS-Stream-10-latest-aarch64-dvd1.iso', architecture: 'ARM64' },
    ],
  },
  {
    name: 'Kali Linux',
    ...
    links: [
      ...
      { url: 'https://cdimage.kali.org/kali-2026.1/kali-linux-2026.1-installer-arm64.iso',               architecture: 'ARM64' },
      { url: 'https://kali.download/arm-images/kali-2026.1/kali-linux-2026.1-raspberry-pi-arm64.img.xz', architecture: 'Raspberry Pi' },
    ],
  },
  {
    name: 'Parrot OS',
    ...
    links: [
      ...
      { url: 'https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_amd64.iso',      architecture: 'x64',          type: 'Home Edition' },
      { url: 'https://deb.parrot.sh/parrot/iso/7.1/Parrot-spin-htb-7.1_amd64.iso',  architecture: 'x64',          type: 'Hack The Box Edition' },
      { url: 'https://deb.parrot.sh/parrot/iso/7.1/Parrot-core-7.1_rpi.img.xz',     architecture: 'Raspberry Pi', type: 'Core Edition (recommended)' },
      { url: 'https://deb.parrot.sh/parrot/iso/7.1/Parrot-security-7.1_rpi.img.xz', architecture: 'Raspberry Pi', type: 'Security Edition' },
      { url: 'https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_rpi.img.xz',     architecture: 'Raspberry Pi', type: 'Home Edition' },
    ],
  },
  {
    name: 'NixOS',
    ...
    links: [
      ...
      { url: 'https://channels.nixos.org/nixos-25.11/latest-nixos-minimal-x86_64-linux.iso',    architecture: 'x64 (recommended)', type: 'Minimal' },
      { url: 'https://channels.nixos.org/nixos-25.11/latest-nixos-graphical-aarch64-linux.iso', architecture: 'ARM64',             type: 'Graphical (recommended)' },
      { url: 'https://channels.nixos.org/nixos-25.11/latest-nixos-minimal-aarch64-linux.iso',   architecture: 'ARM64',             type: 'Minimal' },
    ],
  },
  {
    name: 'Tails',
  ...
  },
  {
    ...
    links: [
      ...
      { url: 'https://dl-cdn.alpinelinux.org/alpine/v3.23/releases/aarch64/alpine-standard-3.23.4-aarch64.iso',    architecture: 'ARM64' },
      { url: 'https://dl-cdn.alpinelinux.org/alpine/v3.23/releases/aarch64/alpine-rpi-3.23.4-aarch64.img.gz',      architecture: 'Raspberry Pi' },
    ],
  },
  {
    name: 'Void Linux',
    ...
    links: [
      ...
      { url: 'https://repo-default.voidlinux.org/live/current/void-live-x86_64-20250202-base.iso',  architecture: 'x64 (recommended)', type: 'base' },
      { url: 'https://repo-default.voidlinux.org/live/current/void-live-aarch64-20250202-xfce.iso', architecture: 'ARM64', type: 'xfce (recommended)' },
      { url: 'https://repo-default.voidlinux.org/live/current/void-live-aarch64-20250202-base.iso', architecture: 'ARM64', type: 'base' },
      { url: 'https://repo-default.voidlinux.org/live/current/void-rpi-aarch64-20250202.img.xz',    architecture: 'Raspberry Pi' },
    ],
  },
  {
    name: 'Gentoo',
    ...
    links: [
      ...
      { url: 'https://distfiles.gentoo.org/releases/amd64/autobuilds/current-install-amd64-minimal/install-amd64-minimal-20260426T153103Z.iso', architecture: 'x64 (recommended)', desktop: 'None' },
      { url: 'https://distfiles.gentoo.org/releases/arm64/autobuilds/current-install-arm64-minimal/install-arm64-minimal-20260503T230109Z.iso', architecture: 'ARM64',             desktop: 'None' },
    ],
  },
  {
    name: 'CachyOS',
...
function openDownload(idx) {
  ...
  dlState = {
    ...
    totalSteps:   computeTotalSteps(distro.links, [], attrOrder),
  };

  renderDownloadStep();
}

/* Compute maximum number of steps across ALL possible paths */
...
function renderDownloadStep() {
  ...
  if (!next) {
    renderDownloadFinal(s.filtered[0].url);
    return;
  }
...
function selectOption(itemEl, value) {
  ...
  const nextFiltered = dlState.filtered.filter(l =>
    (l[dlState.currentAttr] || null) === value
  );
  const nextAsked = [...dlState.asked, dlState.currentAttr];
  const furtherAttr = getNextAttr(nextFiltered, nextAsked, dlState.attrOrder);

  if (!furtherAttr) {
    btnNext.textContent = '⬇ Download';
    btnNext.onclick = handleDownloadFinal;
  } else {
    btnNext.textContent = 'Next ›';
    btnNext.onclick = handleNext;
  }
...
function handleDownloadFinal() {
  ...
  const finalFiltered = s.filtered.filter(l =>
    (l[s.currentAttr] || null) === s.selected
  );

  if (finalFiltered.length === 0) return;
  triggerDownload(finalFiltered[0].url);
}
